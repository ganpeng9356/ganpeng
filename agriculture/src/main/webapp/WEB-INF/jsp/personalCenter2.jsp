...
<script rel="stylesheet" type="text/javascript" src="${pageContext.request.contextPath}/js/personal2.js"></script>
...
<div id="divnong" class="divTab">
    ...
    <c:forEach items="${record}" var="record">
        <tr>
            <th colspan="6" rowspan="2">购买时间：${record.rtime }</th>         
        </tr>
        <tr >
            <th colspan="5" rowspan="3" ><img src="${pageContext.request.contextPath}${record.croute}${record.cimg}" style="width:100px;height:100px"></th>
        </tr>
        <tr>
            <td>商品名</td>
            <td>价格</td>
        ...
        <tr>
            <td>${record.cname }</td>
            <td>${record.rpice }(元)</td>
            <td>${record.cweight }(kg)</td>
            <td>${record.ccolor }</td>
            <td>${record.cstate }</td>
        </tr>
        </c:forEach>
